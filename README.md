...
4차 산업혁명 및 초거대 AI 기술의 확산과 함께 지역 산업 구조가 급속히 변화하고 있다.

특히 서울·수도권 산업체는 **AI 개발자, 데이터 분석 인력, 모빌리티·제조·콘텐츠 분야의 X+AI 융합형 전문인력**을 요구하고 있다.

국민대학교 소프트웨어학부는 이러한 산업변화에 대응하기 위해 **“지역산업 수요 기반 맞춤형 교육과정(Customized Curriculum)”**을 개발하여 산업 현장에서 즉시 활용 가능한 실무형·현장형 인재 양성을 목표로 한다.
